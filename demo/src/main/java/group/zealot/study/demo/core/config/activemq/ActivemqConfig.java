package group.zealot.study.demo.core.config.activemq;
...
public class ActivemqConfig {
    ...
    @Bean
    public DefaultJmsListenerContainerFactory activemqJmsListenerFactory(JmsPoolConnectionFactory jmsPoolConnectionFactory) {
