...
public class SftpUtil {
     ...
     * @param sftp           sftp
     */
    public static void upload(InputStream inputStream, String directory, String uploadFileName, ChannelSftp sftp)
     ...
     * @param sftp           sftp
     */
    public static void upload(File flie, String directory, String uploadFileName, ChannelSftp sftp)
            throws SftpException, FileNotFoundException {
     ...
     * @param sftp         sftp
     */
    public static void download(String directory, String downloadFile, File file, ChannelSftp sftp)
            throws SftpException, FileNotFoundException {
     ...
     * @param sftp      sftp
     */
    public static boolean isHaveDir2(String directory, ChannelSftp sftp) throws SftpException {
     ...
     * @param sftp      sftp
     */
    public static boolean isHaveFile3(String directory, String fileName, ChannelSftp sftp) throws SftpException {
    ...
    public static SftpATTRS stat(String directory, ChannelSftp sftp) throws SftpException {
        logger.debug("开始 stat " + directory);
        return sftp.stat(directory);
    }

    protected static void disConnectedSftp(ChannelSftp old) {
        if (old != null) {
